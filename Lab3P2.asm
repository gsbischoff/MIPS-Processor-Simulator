...
#			equivalently the largest power of 2 >= to arg n
	...
	addi	$8, $0, 455# Move in the argument of the routine
...
#	loopBegin:					# Start of the loop
	srl		$8, $8, 1 		# Rightshift t0 by 1
	beq		$8, $0, 0x2		# If our value has reached 0, branch from loop
	addi	$9, $9, 1 		# Add 1 for 1 rightshift on our value
	beq		$0, $0, -0x3		# Branch to start since our value hasn't reached 0
#	loopEnd:
